            ...
            <SwiperSlide>
              <div className="slider s1 container">
                <div className="text">
                  ...
                  <p>
                    더 많이 읽을수록, 더 많은 것을 알게 됩니다.
                    <br />더 많이 배울수록, 더 많은 곳에 갈 수 있습니다.
                  </p>
                  <a href="/" className="more button_orenge">
                    더 알아보기
                  </a>
                </div>
                <div className="img" aria-label="hidden">
                  <img
                    src="./assets/images/slider/slider01.png"
                    alt="이미지1"
                  />
                  <img
                    src="./assets/images/slider/slider02.png"
                    alt="이미지2"
                  />
                  <img
                    src="./assets/images/slider/slider03.png"
                    alt="이미지3"
                  />
                </div>
